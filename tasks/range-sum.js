...
// jeigu from < to  tai ciklas  from to, jeigu from > 0, tai cikas to - from
...
function rangeSum (from, to) {
  ...
  if (from % 1 !== 0) {
    return "ERROR: pirmas parametras turi buti sveikasis skacius.";
  }

  if (to % 1 !== 0) {
    return "ERROR: antras parametras turi buti sveikasis skacius.";
  }
