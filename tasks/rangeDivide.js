/* 
Kiek duotame intervale (imitinai) yra skaiciu, kurie dalinasi be liekanos is duoto daliklio
*/
...
function rangeDivide (from, to, divider) {
    ...
    if (divider === 0) {
        return 'Tracias parametras negali buti (0)'
    }

    if (divider <= 0) {
        return 'Tracias parametras negali buti mazesnis uz (1)'
    }
...
// console.log(rangeDivide(8, 31, 3), '--', 'Skaičių intervale tarp 8 ir 31, besidalijančių be liekanos iš 3 yra 4 vienetai.');
